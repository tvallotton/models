...
//! | `u32`                | INT UNSIGNED             | INT UNSIGNED             | INT UNSIGNED             |
//! | `u64`                | BIGINT UNSIGNED          | BIGINT UNSIGNED          | BIGINT UNSIGNED          |
//! | `f32`                | REAL                     | FLOAT                    | REAL                     |
...
struct VarChar<const SIZE: usize>(pub String); 
struct VarBinary<const SIZE: usize>(pub Vec<u8>); 
#[cfg(feature="binary")]
struct Bytes<T>(pub T);
#[cfg(feature="json")]
struct Json<T>(pub T);
#[cfg(feature="chrono")]
use chrono::DateTime; 
